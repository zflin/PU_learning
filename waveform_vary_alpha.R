...
save(alpha_est_croc_patrasen, file = 'results/waveform_vary_alpha_croc_patrasen.RData')
...
save(alpha_est_spy, file = 'results/waveform_vary_alpha_spy.RData')
...
save(alpha_est_roc, file = 'results/waveform_vary_alpha_roc.RData')
